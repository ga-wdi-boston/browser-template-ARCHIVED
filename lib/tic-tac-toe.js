...
// the current player.
//
// Game.prototype.isMoveLegal(player, move): returns true or false to indicate the legality of the given move
//
// Game.prototype.move(player, move): makes the specified move, if it is legal.  Returns true if the move was legal and succeeded, false otherwise.
//
// Game.prototype.vififyGame(moveList): updates the game as if it were reset and then the moves in moveList were played.
//
// Game.prototype.whoPlayedAt(square): returns X, O, or undefined, depending on the contents of the square.
