...
/***/ function(module, exports, __webpack_require__) {
	...
	var quoteEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUpUser = function onSignUpUser(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { signUp: signUp, signIn: signIn, changePassword: changePassword, signOut: signOut };
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetQuotes = function onGetQuotes(event) {
	  console.log('getQuotes fired');
	  event.preventDefault();
	  api.getQuotes().then(ui.getQuotesSuccess).catch(ui.failure);
	};
	...
	var createQuote = function createQuote(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.create({ quote: data.quote }).then(ui.createQuoteSuccess).catch(ui.failure);
	};

	var updateQuote = function updateQuote(event) {
	  console.log('updateQuote fired');
	  event.preventDefault();
	  var quoteData = getFormFields(event.target);
	  var quoteId = $(this).attr('data-id');
	  api.update(quoteData, quoteId).then(ui.updateQuoteSuccess).then(api.getQuotes).then(ui.getQuotesSuccess).catch(ui.failure);
	};

	var deleteQuote = function deleteQuote() {
	  console.log('deleteQuote fired');
	  event.preventDefault();
	  api.destroy($(this).attr('data-id')).then(ui.success).then(api.getQuotes).then(ui.getQuotesSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var showQuotesTemplate = __webpack_require__(12);
	var api = __webpack_require__(10);

	var getQuotesSuccess = function getQuotesSuccess(quotes) {
	  $('#content').html(showQuotesTemplate(quotes, "cool"));
	  console.log('quotes is', quotes);
	};

	var createQuoteSuccess = function createQuoteSuccess(quotes) {
	  $('#content').html(showQuotesTemplate(quotes.id, "cool"));
	  console.log('quotes is', quotes);
	};

	var updateQuoteSuccess = function updateQuoteSuccess(quotes) {
	  $('#content').html(showQuotesTemplate(quotes, "cool"));
	  api.getQuotes();
	...
	module.exports = {
	  showQuotesTemplate: showQuotesTemplate,
	  getQuotesSuccess: getQuotesSuccess,
	  createQuoteSuccess: createQuoteSuccess,
	  updateQuoteSuccess: updateQuoteSuccess
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"quote\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <h1> <small>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quoteText : stack1), depth0))
	    + "</small></h1>\n    <div>\n"
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.quotes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
